...
impl BinaryLoader {
    ...
    pub fn load_and_run(data: &[u8], load_addr: u64) -> Result<(), &'static str> {
        crate::vdebug!("ASM", "Loading raw binary of size {} at 0x{:x}", data.len(), load_addr);
        ...
        crate::vdebug!("ASM", "Binary allocated at 0x{:x}", dest as u64);
        ...
        crate::vdebug!("ASM", "Executing binary...");
